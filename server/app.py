...
\"rewritten_version\": \"*a LONG string that represents an unbiased, child-language-friendly rewritten article combined from all the articles provided in the article links, that is BETWEEN 3500 and 4000 characters in length*\"
}
"""
